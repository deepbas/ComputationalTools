...
r = 5; s = 10
starttime <- Sys.time()
sim1 <- mclapply(1:nrep, function(i) linearcomb(beta1 = 1.1, r = r, s=s, n = 1e5, root = "sqroot"), 
...
r = 3; s = 7
starttime <- Sys.time()
sim2 <- mclapply(1:nrep, function(i) linearcomb(beta1 = 0.99, r = r, s = s, n = 5e4, root = "cuberoot"), 
                 mc.preschedule = TRUE, mc.cores = 4)
endtime <- Sys.time()
endtime - starttime
